...
class FormConfiguracion(Form):
    def __init__(self,screen,x,y,w,h,active, path_img):
        ...
        self.btn_play = Button_Image(self._slave,x,y,1220,480,110,110,"PROYECTO PYGAME\Recursos\Superficie\pngwing.com (1).png", self.btn_play_click,"None")
        self.lista_widgets.append(self.btn_play)

        self.volumen = 0.2
        self.flag_play = True

        self.label_volumen = Label(self._slave, 1220, 380, 100, 50, "20%","Comic Sans",15,"Black","PROYECTO PYGAME\Recursos\Interfaz\inter (1).png")
