...
class NivelDos(Nivel):
    def __init__(self, pantalla: pygame.Surface):
        ...
        fondo = pygame.image.load("PROYECTO PYGAME\Recursos\Fondos_Imagenes\—Pngtree—business city blue technology city_1320031.jpg")
        ...
        plataforma = Superficie((95,95),(500,680),"PROYECTO PYGAME\Recursos\Superficie\piedra1.png")
        plataforma_dos = Superficie((200,55),(830,490),"PROYECTO PYGAME\\Recursos\\Superficie\\base (1).png")
        plataforma_tres = Superficie((200,55),(610,580),"PROYECTO PYGAME\\Recursos\\Superficie\\base (1).png")
        plataforma_cuatro = Superficie((200,55),(1080,420),"PROYECTO PYGAME\\Recursos\\Superficie\\base (1).png")
        plataforma_cinco = Superficie((200,55),(200,580),"PROYECTO PYGAME\\Recursos\\Superficie\\base (1).png")
        plataforma_seis = Superficie((200,55),(1280,300),"PROYECTO PYGAME\\Recursos\\Superficie\\base (1).png")
        plataforma_ocho = Superficie((200,55),(100,470),"PROYECTO PYGAME\\Recursos\\Superficie\\base (1).png")
        plataforma_nueve = Superficie((200,55),(1680,300),"PROYECTO PYGAME\\Recursos\\Superficie\\base (1).png")
        ...
        municion = Item((30,25), (plataforma_cuatro.lados["main"].centerx - 15, plataforma_cuatro.lados["main"].y - 30),"PROYECTO PYGAME\\Recursos\\Disparo\\23.png")
        municion_dos = Item((30,25),(1000, 695),"PROYECTO PYGAME\\Recursos\\Disparo\\23.png")
        municion_tres = Item((30,25),(1700,695),"PROYECTO PYGAME\\Recursos\\Disparo\\23.png")
        municion_cuatro = Item((30,25),(plataforma_nueve.lados["main"].centerx - 15, plataforma_nueve.lados["main"].y - 30),"PROYECTO PYGAME\\Recursos\\Disparo\\23.png")
        municion_cinco = Item((30,25),(plataforma_seis.lados["main"].centerx - 15, plataforma_seis.lados["main"].y - 30),"PROYECTO PYGAME\\Recursos\\Disparo\\23.png")
